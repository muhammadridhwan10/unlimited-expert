    ...
    <script>
        ...
        $(document).ready(function () {
            var table = $('#report-dataTable').DataTable({
                ...
                lengthMenu: [[10, 25, 50, 100], [10, 25, 50, 100]], // Custom entries per page
                pageLength: 50, // Default entries per page
            });

            // Mengubah jumlah entri per halaman saat dropdown berubah
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select('branch_id', $branch, isset($_GET['branch_id']) ? $_GET['branch_id'] : '', ['class' => 'form-control select']) }}
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <div class="btn-box">
