...
@section('action-btn')
    <div class="float-end">
        <a href="#" data-size="lg" data-url="{{ route('reimbursment-personal.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Reimbursement Personal')}}" class="btn btn-sm btn-primary">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(array('route' => array('reimbursment-personal.index'),'method'=>'get','id'=>'report_monthly_reimbursment-personal')) }}
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        <a href="#" class="btn btn-sm btn-primary" onclick="document.getElementById('report_monthly_reimbursment-personal').submit(); return false;" data-bs-toggle="tooltip" title="{{__('Apply')}}" data-original-title="{{__('apply')}}">
                                            <span class="btn-inner--icon"><i class="ti ti-search"></i></span>
                                        </a>
                                        <a href="{{route('reimbursment-personal.index')}}" class="btn btn-sm btn-danger " data-bs-toggle="tooltip"  title="{{ __('Reset') }}" data-original-title="{{__('Reset')}}">
                                    ...
                                    <td>
                                        @if($reimbursment->status == "Pending")
                                            <div class="action-btn bg-primary ms-2">
                                                <a href="#" data-url="{{ URL::to('reimbursment-personal/'.\Crypt::encrypt($reimbursment->id).'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Medical Allowance')}}" class="mx-3 btn btn-sm  align-items-center" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                            </div>
                                        @endif
                                    </td>
                                </tr>
