                    ...
                    <div class="preview-main client-preview">
                        <div data-v-f2a183a6="" class="d" id="boxes" style="width:710px;margin-left: auto;margin-right: auto;">
                            ...
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to" style="margin-top:-40px">
                                    <div class="row">
                                        <div class="bill_to">
...
{{--                                                            </div>--}}
                                                            <div class="d-table-value"><span>
                                                                ...
                                                                @elseif($invoice->currency == 'S$')
                                                                    {{Utility::priceFormat4($settings,$item->price)}}
                                                                @else
                                        ...
                                        <div data-v-f2a183a6="" class="d-header-brands-left" style="margin-top: 50px;">
                                            ...
                                            <p>
                                                ...
                                                <p style= "text-align:center">
                                                 <img src="{{$ttd}}" style="width: 210px; margin-top: 30px;"/>
                                                <br>
                                                {{"Melya Lubis"}}<br>
                                    ...
                                    <div class="row">
                                        <div data-v-f2a183a6="" class="d-header-brands-left" style="margin-top: -20px;">
                                            ...
                                            <p style="font-size: 10px;">
                                                KAP Agus Ubaidillah dan Rekan Practice License KMK No. 386/KM.1/2012 <br>
                                                Wisma Staco Lt.6, Jl. Casablanca Kav. 18. Jakarta 12960, Indonesia <br>
