                  ...
                  <div class="invoice-print">
                      <div class="row invoice-title mt-2">
                          ...
                          <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                              <h3 class="invoice-number float-right">{{ $invoice->invoice_id }}</h3>
                          </div>
                          <div class="col-12">
                              <hr>
                          </div>
                          ...
                          @if(!empty($customer->name))
                              <div class="col">
                                  <small class="font-style">
                                      ...
                                      {{!empty($client->telp)?$client->telp:''}}<br>
                          ...
                          @endif
                              <div class="col">
                                  <small>
                                      ...
                                      {{!empty($client->name_invoice)?$client->name_invoice:''}}<br>
                                      {{!empty($client->position)?$client->position:''}}<br>
                                  ...
                                  <table class="table mb-0 table-striped">
                                      ...
                                      @foreach($iteams as $key =>$iteam)
                                          ...
                                          <tr>
                                              ...
                                              <td></td>
                                              <td></td>
                                              <td class="text-end">{{$user->priceFormat($iteam->price)}}</td>
                                          </tr>
                                      @endforeach
                                      <tfoot>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <tr>
                                            <td colspan="6"></td>
                                            <td class="text-end"><b>{{__('Tax Total')}}</b></td>
                                            <td class="text-end">{{ $user->priceFormat($invoice->getTotalTax()) }}</td>
                                        </tr>
                                      <tr>
                                          <td colspan="6"></td>
                          ...
                          <section class="nav-tabs p-2">
                              @if ((isset($company_payment_setting['is_stripe_enabled']) && $company_payment_setting['is_stripe_enabled'] == 'on') ||
                                  ...
                                  <ul class="nav nav-pills  mb-3" role="tablist">
                                      ...
                                      @if($company_payment_setting['is_tripay_enabled'] == 'on' && !empty($company_payment_setting['tripay_merchant_code']) && !empty($company_payment_setting['tripay_api_key']) && !empty($company_payment_setting['tripay_private_key']))
                                          <li class="nav-item mb-2">
                                              <a class="btn btn-outline-primary btn-sm me-1 ml-1" data-bs-toggle="tab" href="#tripay-payment" role="tab" aria-controls="tripay" aria-selected="false">{{ __('Tripay') }}</a>
                                          </li>
                                      @endif
                              ...
                              <div class="tab-content">
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-6">
                                                      ...
                                                      <div class="choose-file form-group">
                                                          <input type="file" accept=".png, .jpeg, .jpg, .pdf" name="payment_receipt" id="image" class="form-control" >
                                  ...
                                  @if(!empty($company_payment_setting) &&  ($company_payment_setting['is_tripay_enabled'] == 'on' && !empty($company_payment_setting['tripay_merchant_code']) && !empty($company_payment_setting['tripay_api_key']) && !empty($company_payment_setting['tripay_private_key'])))
                                      <div class="tab-pane fade" id="tripay-payment" role="tabpanel" aria-labelledby="tripay-payment">
                                          <form class="w3-container w3-display-middle w3-card-4 " method="POST" id="payment-form" action="{{ route('customer.pay.with.tripay',$invoice->id) }}">
                                              @csrf
                                              <div class="row">
                                                  <div class="form-group col-md-12">
                                                      <label for="amount">{{ __('Amount') }}</label>
