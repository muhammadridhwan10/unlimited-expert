                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('rate_partners',null, array('class'=>'form-control','required'=>'required', 'id'=>'rate_partners'))}}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('rate_manager', null, array('class'=>'form-control','required'=>'required', 'id'=>'rate_manager'))}}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('rate_senior', null, array('class'=>'form-control','required'=>'required', 'id'=>'rate_senior'))}}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('rate_associate', null, array('class'=>'form-control','required'=>'required', 'id'=>'rate_associate'))}}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('rate_assistant', null, array('class'=>'form-control','required'=>'required', 'id'=>'rate_assistant'))}}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('budget', null, ['class' => 'form-control', 'readonly', 'id'=>'budget']) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
