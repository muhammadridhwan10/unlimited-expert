                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        <a href="#" class="btn btn-sm btn-primary" onclick="document.getElementById('report_reimbursment').submit(); return false;" data-bs-toggle="tooltip" title="{{__('Apply')}}" data-original-title="{{__('apply')}}">
                                            <span class="btn-inner--icon"><i class="ti ti-search"></i></span>
                                        </a>
                                        <a href="{{route('report.reimbursment')}}" class="btn btn-sm btn-danger " data-bs-toggle="tooltip"  title="{{ __('Reset') }}" data-original-title="{{__('Reset')}}">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @foreach($employeesReimbursment as $reimbursment)
                                        <tr>
                                            <td>{{$reimbursment['name']}}</td>
                                            <td>{{number_format($reimbursment['total_reimbursment'])}}</td>
                                            <td>{{number_format($reimbursment['paid_amount'])}}</td>
