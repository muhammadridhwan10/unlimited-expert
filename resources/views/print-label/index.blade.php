                    ...
                    <form id="labelForm" method="POST" action="{{ route('print.labels') }}">
                        ...
                        <div id="labelInputContainer">
                            <div class="label-group">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="sender_receiver">{{__('Sender/Receiver')}}</label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="pic_phone">{{__('PIC Handphone Number')}}</label>
                                        <input type="text" name="pic_phone[]" class="form-control" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="remarks">{{__('Notes')}}</label>
                        ...
                        <br>
                        <button type="button" class="btn btn-primary" onclick="addLabel()">{{__('Add Label')}}</button>
                        <button type="submit" class="btn btn-success">{{__('Print Label')}}</button>
                    </form>
                </div>
            </div>
        </div>
