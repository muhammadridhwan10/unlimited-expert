                ...
                @if(\Auth::user()->type != 'client')
                    <ul class="dash-navbar">
                        ...
                        <!--------------------- End Dashboard ----------------------------------->
                            ...
                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'leave' || Request::segment(1) == 'overtime' || Request::segment(1) == 'leave' || Request::segment(1) == 'report-hrm' || Request::segment(1) == 'medical-allowance' || Request::segment(1) == 'reimbursment-personal' || Request::segment(1) == 'reimbursment-client')?'active dash-trigger':''}}">
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'report-hrm') ? 'active dash-trigger' : ''}}" href="#hr-report" data-toggle="collapse" role="button" aria-expanded="{{(Request::segment(1) == 'report-hrm') ? 'true' : 'false'}}">
                                        <a class="dash-link" href="#">{{__('Reports')}}<span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            <li class="dash-item  {{(Request::route()->getName() == 'report.attendance_user') ? 'active' : ''}}">
                                                <a class="dash-link" href="{{route('report.attendance_user') }}">{{__('Attendance')}}</a>
                                            </li>
                                            <li class="dash-item  {{(Request::route()->getName() == 'report.overtime_user') ? 'active' : ''}}">
                                                <a class="dash-link" href="{{route('report.overtime_user') }}">{{__('Overtime')}}</a>
                                            </li>
                                            <li class="dash-item  {{(Request::route()->getName() == 'report.absence_user') ? 'active' : ''}}">
                                                <a class="dash-link" href="{{route('report.absence_user') }}">{{__('Absence Request')}}</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            {{-- @if(\Auth::user()->type == 'staff IT' || \Auth::user()->type == 'partners' || \Auth::user()->type == 'staff' || \Auth::user()->type == 'junior audit' || \Auth::user()->type == 'senior audit' || \Auth::user()->type == 'junior accounting' || \Auth::user()->type == 'senior accounting' || \Auth::user()->type == 'manager audit' || \Auth::user()->type == 'intern')
                                <li class="dash-item dash-hasmenu">
                                    <a href="#!" class="dash-link {{ (Request::segment(1) == 'medical-allowance' || Request::segment(1) == 'reimbursment-personal' || Request::segment(1) == 'reimbursment-client')?' active dash-trigger':''}}"><span class="dash-micon"><i class="ti ti-file-invoice"></i></span><span class="dash-mtext">{{__('Finance')}}</span><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                    <ul class="dash-submenu">
                                        @if(Auth::user()->type !== 'intern')
                                            @if($employee->branch_id == 1)
                                            <li class="dash-item {{ (Request::route()->getName() == 'medical-allowance.index' || Request::route()->getName() == 'medical-allowance.create' || Request::route()->getName() == 'medical-allowance.edit') ? ' active' : '' }}">
                        ...
                        @if(\Auth::user()->show_account() == 1)
                            ...
                            <li class="dash-item dash-hasmenu {{ (Request::route()->getName() == 'print-setting' || Request::segment(1) == 'customer' || Request::segment(1) == 'vender' || Request::segment(1) == 'proposal' || Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer' || Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' ||
                                ...
                                <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-file-invoice"></i></span><span class="dash-mtext">{{__('Finance')}}
                                    </span><span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                                </a>
                                <ul class="dash-submenu">
                                    ...
                                    {{-- <li class="dash-item dash-hasmenu {{(Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note')? 'active dash-trigger' :''}}">
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                <li class="dash-item {{ (Request::segment(1) == 'productservice')?'active':''}}">
                                                    <a href="{{ route('productservice.index') }}" class="dash-link">{{__('Type Of Services')}}
                                                    </a>
                                                </li>
                                                @endif
                                                <li class="dash-item {{ (Request::route()->getName() == 'invoice.index' || Request::route()->getName() == 'invoice.create' || Request::route()->getName() == 'invoice.edit' || Request::route()->getName() == 'invoice.show') ? ' active' : '' }}">
                                    ...
                                    @if(Gate::check('manage constant tax') || Gate::check('manage constant category') ||Gate::check('manage constant unit') ||Gate::check('manage constant payment method') ||Gate::check('manage constant custom field') )
                                        <li class="dash-item {{(Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'active dash-trigger' :''}}">
                                            <a class="dash-link" href="{{ route('product-category.index') }}">{{__('Service Setting')}}</a>
                                        </li>
                                    @endif
                        ...
                        @if(\Auth::user()->show_project() == 1)
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'reports-time-projects') ? 'active dash-trigger' : ''}}" href="#hr-report" data-toggle="collapse" role="button" aria-expanded="{{(Request::segment(1) == 'reports-time-projects') ? 'true' : 'false'}}">
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            @endif
                                            {{-- @if(\Auth::user()->type == 'admin' || \Auth::user()->type == 'company' || \Auth::user()->type == 'partners')
                                            <li class="dash-item {{ request()->is('reports-time-projects') ? 'active' : '' }}">
                            ...
                            {{-- <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'audit') ? ' active' : '' }}">
                                <a href="{{ route('audit.index') }}" class="dash-link">
                                    <span class="dash-micon"><i class="ti ti-home"></i></span><span class="dash-mtext">{{__('Audit Tools')}}</span>
                                </a>
                            </li> --}}
                            @endif
                        @endif
...
{{--                                @endcan--}}
                        ...
                        {{-- @if(Auth::user()->type !== 'staff_client')
                            <li class="dash-item dash-hasmenu">
                                <a href="#!" class="dash-link {{ (Request::segment(1) == 'translate')?' active dash-trigger':''}}"><span class="dash-micon"><i class="ti ti-grid-dots"></i></span><span class="dash-mtext">{{__('New Features')}}</span><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                <ul class="dash-submenu">
                        ...
                        @endif --}}
                            ...
                            <li class="dash-item dash-hasmenu {{ ( Request::segment(1) == 'document-request' || Request::segment(1) == 'print-labels')
                                    ? 'active dash-trigger' : ''}}">
                                <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-tool"></i></span><span class="dash-mtext">{{__('Tools')}}</span><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                <ul class="dash-submenu">
                                    ...
                                    {{-- <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'print-labels')?'active':''}}">
                                        <a href="{{route('print-labels.index')}}" class="dash-link">
                                            </span><span class="dash-mtext">{{__('Print Labels')}}</span>
                                        </a>
                                    </li> --}}
                                </ul>
                            </li>
