...
@section('page-title')
    {{__('Mapping Account Data Create')}}
@endsection
...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'mappingaccountdata','class'=>'w-100')) }}
        <div class="col-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::text('code','', array('class' => 'form-control','required'=>'required','required'=>'required')) }}
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group price-input input-group search-form">
