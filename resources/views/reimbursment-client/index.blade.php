                                ...
                                @foreach ($approval as $approvals)
                                    ...
                                    <td>
                                        <div class="action-btn bg-warning ms-2">
                                            <a href="#" data-url="{{ URL::to('reimbursment-client/'.$approvals->id.'/action') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Reimbursment Action')}}" class="mx-3 btn btn-sm  align-items-center" data-bs-toggle="tooltip" title="{{__('Reimbursment Action')}}" data-original-title="{{__('Reimbursment Action')}}">
