...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('employee-details.index')}}">{{__('Employee List')}}</a></li>
    <li class="breadcrumb-item">  {{ ucwords($employee_detail->name).__("'s Detail") }}</li>
@endsection
@push('css-page')
...
@section('action-btn')
<form action="{{ route('employee-details.show', $employee_detail->id) }}" method="GET">
    <div class="float-end">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="p-4">
                                                        ...
                                                        <h6 class="report-text mb-0">{{ $employee_detail->email }}</h6>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="p-4">
                                                        <p class="card-text mb-0">{{ __('DOB') }}</p>
                                                        <h6 class="report-text mb-3">{{ $employee_detail->employee->dob ? $employee_detail->employee->dob : '-' }}</h6>
                                                        <p class="card-text mb-0">{{ __('Gender') }}</p>
                                                        <h6 class="report-text mb-0">{{ $employee_detail->employee->gender ? $employee_detail->employee->gender : '-' }}</h6>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="p-4">
                                                        <p class="card-text mb-0">{{ __('Phone') }}</p>
                                                        <h6 class="report-text mb-3">{{ $employee_detail->employee->phone ? $employee_detail->employee->phone : '-' }}</h6>
                                                        <p class="card-text mb-0">{{ __('Address') }}</p>
                                                        <h6 class="report-text mb-3">{{ $employee_detail->employee->address ? $employee_detail->employee->address : '-' }}</h6>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body table-border-style table-border-style">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        @forelse ($employee_detail->userProject($employee_detail->id) as $project)
                                                        <tr class="font-style">
                                                            ...
                                                            <td>{{ $project->totalEstimatedHrs($employee_detail->id) ?? 0 }} {{__('H')}}</td>
                                                            <td>{{ $project->totalHoursUser($employee_detail->id) }} {{__('H')}}</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                {{ $employee_detail->userProject($employee_detail->id)->links() }}
                                            </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body table-border-style table-border-style">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        @forelse ($employee_detail->userTracker($employee_detail->id, $filter) as $tracker)
                                                        <tr class="font-style">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            {{ $employee_detail->userTracker($employee_detail->id, $filter)->links() }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <h3 class="mt-3">
                                                {{ $employee_detail->getTotalTimesheetHours($employee_detail->id, $filter) ?? '00:00:00' }}
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body table-border-style table-border-style">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        @forelse ($employee_detail->userTimesheet($employee_detail->id, $filter) as $timesheet)
                                                        <tr class="font-style">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            {{ $employee_detail->userTimesheet($employee_detail->id, $filter)->links() }}
                                        </div>
                                    </div>
                                </div>
                            </div>
