{{ Form::open(['url' => 'document-request', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('client_name_invoice', null, array('class'=>'form-control'))}}
                </div>
            </div>
    ...
    <div id="proposal_fields" style="display: none;">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('client_name_proposal', null, array('class'=>'form-control'))}}
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{Form::text('email_attention_proposal',null,array('class'=>'form-control'))}}
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('name_attention_proposal', null, array('class'=>'form-control'))}}
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{Form::text('position_attention_proposal',null,array('class'=>'form-control'))}}
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{Form::textarea('address_proposal',null,array('class'=>'form-control'))}}
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    {{ Form::label('period_proposal', __('Period Service'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                    {{Form::text('period_proposal',null,array('class'=>'form-control'))}}
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{Form::text('fee_proposal',null,array('class'=>'form-control'))}}
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <label class="form-check-label">
                            {{ Form::radio('pph23_proposal', 'include', false, ['class' => 'form-check-input']) }} {{ __('Include') }}
                        </label>
                        <label class="form-check-label">
                            {{ Form::radio('pph23_proposal', 'non_include', false, ['class' => 'form-check-input']) }} {{ __('Non Include') }}
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::text('client_name_barcode', null, array('class'=>'form-control'))}}
                </div>
            </div>
        </div>
    </div>
