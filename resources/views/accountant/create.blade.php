...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Accountant Create')}}</li>
@endsection
@push('script-page')
...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'accountant','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="table-responsive">
                        <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::text('client_public_accountant_code','', array('class' => 'form-control')) }}
                                    </div>
                                </td>
                                <td>
