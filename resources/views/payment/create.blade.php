...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{ Form::label('approval_required', __('Require Approval?'),['class'=>'form-label']) }}
            {{ Form::checkbox('approval_required', 'yes', false, array('id' => 'approval_required', 'class' => 'form-check-input')) }}
        </div>
        <div class="form-group col-md-6" id="approval-container" style="display: none;">
        ...
        {{-- <div class="form-group col-md-6">
            ...
            {{ Form::select('account_id', $accounts,null, array('class' => 'form-control select2','id' => 'account_id','required'=>'required')) }}
        </div> --}}
        <div class="form-group col-md-6">
...
<script>
    ...
    function toggleApprovalField() {
        var approvalRequired = document.getElementById('approval_required').checked;
        var approvalContainer = document.getElementById('approval-container');
        approvalContainer.style.display = approvalRequired ? 'block' : 'none';
    }
    ...
    document.getElementById('approval_required').addEventListener('change', toggleApprovalField);
