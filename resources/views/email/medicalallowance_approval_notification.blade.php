<div style="background-color:#f6f6f6;font-family:sans-serif;font-size:14px;line-height:1.4;margin:0;padding:0">
    <span style="color:transparent;display:none;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;width:0">Halo! {{ $reimbursment->employee->name }} Thank you for submitting your medical allowance request. We are pleased to inform you that your medical allowance application has been <strong>APPROVED</strong>.</span>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top" valign="top">
                                                        ...
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">Thank you for submitting your medical allowance request. We are pleased to inform you that your medical allowance application has been <strong>APPROVED</strong> and the status has been updated to <strong>PAID</strong> in the application.</p>
                                                        <br>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">An amount of {{ number_format($reimbursment->amount) }} has been transferred to the registered account to help support medical expenses.</p>
                                                        <br>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">Please note that this medical allowance is provided within the limits and conditions set by the company. If you require further assistance or have any questions regarding this payment, please do not hesitate to contact the finance department or human resources.</p>
                                                        <br>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">Thank you for your cooperation and dedication as part of our team.</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
