<div style="background-color:#f6f6f6;font-family:sans-serif;font-size:14px;line-height:1.4;margin:0;padding:0">
    <span style="color:transparent;display:none;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;width:0">Halo! {{ $overtime->approvals->name }} We have received an overtime request from  {{ $overtime->employee->name }}.</span>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top" valign="top">
                                                        ...
                                                        <br>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">Halo! {{ $overtime->approvals->name }}</p>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">We have received an overtime request from  {{ $overtime->employee->name }}. Here are the details of the overtime request:</p>
                                                        <br>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">
                                                        Employee Name:
                                                        </p>
                                                        <h2 style="color:#444444;font-family:sans-serif;font-weight:600;line-height:1.4;margin:0;margin-bottom:15px">{{ $overtime->employee->name }}</h2>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">
                                                        Project Name:
                                                        </p>
                                                        <h2 style="color:#444444;font-family:sans-serif;font-weight:600;line-height:1.4;margin:0;margin-bottom:15px">{{ $overtime->project->project_name }}</h2>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">
                                                        Start Date:
                                                        </p>
                                                        <h2 style="color:#444444;font-family:sans-serif;font-weight:600;line-height:1.4;margin:0;margin-bottom:15px">{{ $overtime->start_date }}</h2>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">
                                                        Start Time:
                                                        </p>
                                                        <h2 style="color:#444444;font-family:sans-serif;font-weight:600;line-height:1.4;margin:0;margin-bottom:15px">{{ $overtime->start_time }}</h2>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">
                                                        End Time:
                                                        </p>
                                                        <h2 style="color:#444444;font-family:sans-serif;font-weight:600;line-height:1.4;margin:0;margin-bottom:15px">{{ $overtime->end_time }}</h2>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">
                                                        Note:
                                                        </p>
                                                        <h2 style="color:#444444;font-family:sans-serif;font-weight:600;line-height:1.4;margin:0;margin-bottom:15px">{{ $overtime->note }}</h2>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">We ask you to consider approving this overtime.</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
