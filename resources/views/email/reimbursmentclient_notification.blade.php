<div style="background-color:#f6f6f6;font-family:sans-serif;font-size:14px;line-height:1.4;margin:0;padding:0">
    <span style="color:transparent;display:none;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;width:0">Halo! {{ $reimbursment->approvals->name }} We have received an client reimbursement request from  {{ $reimbursment->employee->name }}.</span>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top" valign="top">
                                                        ...
                                                        <br>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">Halo! {{ $reimbursment->approvals->name }}, Please allow the Admin to approve the client reimbursment application submitted by me.</p>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">The details of this client reimbursement application are as follows:</p>
                                                        <br>
