<div style="background-color:#f6f6f6;font-family:sans-serif;font-size:14px;line-height:1.4;margin:0;padding:0">
    <span style="color:transparent;display:none;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;width:0">Pemberitahuan Lamaran Baru.</span>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top" valign="top">
                                                        ...
                                                        <br>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">Halo Tim HR, Kami ingin memberitahu Anda bahwa ada seorang kandidat baru yang telah mengirimkan lamaran pekerjaan. Harap periksa profil kandidat tersebut melalui Aplikasi AUP-APPS, yang dapat Anda temukan di menu 'Recruitment' dan 'Job Application', Terima kasih!.</p>
                                                        <br>
                                                    </td>
                                                </tr>
                                            </tbody>
