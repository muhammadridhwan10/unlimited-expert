<div style="background-color:#f6f6f6;font-family:sans-serif;font-size:14px;line-height:1.4;margin:0;padding:0">
    <span style="color:transparent;display:none;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;width:0">Halo! Kami mengundang anda untuk hadir zoom meeting. Link bersifat rahasia. Harap tidak memberitahukannya ke siapa pun termasuk pihak yang mengatasnamakan Unlimited Expert.</span>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top" valign="top">
                                                        ...
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px"> Kami mengundang anda untuk hadir zoom meeting, antara lain:</p>
                                                        <br>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">
                                                        Pembahasan:
                                                        </p>
                                                        <h2 style="color:#444444;font-family:sans-serif;font-weight:600;line-height:1.4;margin:0;margin-bottom:15px">{{ $zoommeeting->title }}</h2>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">
                                                        Project:
                                                        </p>
                                                        <h2 style="color:#444444;font-family:sans-serif;font-weight:600;line-height:1.4;margin:0;margin-bottom:15px">{{ $zoommeeting->project }}</h2>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">
                                                        Tanggal:
                                                        </p>
                                                        <h2 style="color:#444444;font-family:sans-serif;font-weight:600;line-height:1.4;margin:0;margin-bottom:15px">{{ $zoommeeting->start_date }}</h2>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">
                                                        Link Zoom:
                                                        </p>
                                                        <h2 style="color:#444444;font-family:sans-serif;font-weight:600;line-height:1.4;margin:0;margin-bottom:15px">{{ $zoommeeting->start_url }}</h2>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
