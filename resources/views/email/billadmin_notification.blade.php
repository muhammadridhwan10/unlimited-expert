<div style="background-color:#f6f6f6;font-family:sans-serif;font-size:14px;line-height:1.4;margin:0;padding:0">
    <span style="color:transparent;display:none;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;width:0">Dear {{ $payment->user->name }}, A new bill has been generated from Admin. Please review the details.</span>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top" valign="top">
                                                        ...
                                                        <br>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">Dear,{{ $payment->user->name }}</p>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:5px">We are pleased to inform you that a new bill has been generated from Admin. Please review the details in the AUP APP.</p>
                                                        <br>
