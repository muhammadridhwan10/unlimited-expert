<div style="background-color:#f6f6f6;font-family:sans-serif;font-size:14px;line-height:1.6;margin:0;padding:0">
    <span style="color:transparent;display:none;height:0;max-height:0;max-width:0;opacity:0;overflow:hidden;width:0">
        Dear {{ $document->employee->name }}, your requested document is now complete.
    </span>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top" valign="top">
                                                        ...
                                                        <br>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:15px">Dear {{ $document->employee->name }},</p>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:15px">We are pleased to inform you that the document you requested has been successfully completed. Thank you for your patience and trust in our services.</p>
                                                        <p style="color:#444444;font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;margin-bottom:15px">If you have any questions or need further assistance, please do not hesitate to reach out. We are here to support you.</p>
