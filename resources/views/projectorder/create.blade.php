{{Form::open(array('url'=>'project-orders','method'=>'post','enctype' => 'multipart/form-data', 'id' => 'multi-step-form'))}}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="tags" id="tags" class="form-control main-element">
                        <option value="0">{{__('Select Tag')}}</option>                        
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="label" id="label" class="form-control main-element" required>
                        <option value="0">{{__('Select Label')}}</option>
...
<div class="modal-footer">
    ...
    <input type="submit" value="{{__('Create')}}" id="btnSubmit" class="btn  btn-primary" style="display: none;">
</div>
{{Form::close()}}
