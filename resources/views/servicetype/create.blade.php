...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'servicetype','class'=>'w-100')) }}
        <div class="col-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::text('name','', array('class' => 'form-control','required'=>'required','required'=>'required')) }}
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::text('service_type_code','', array('class' => 'form-control','required'=>'required','required'=>'required')) }}
                                    </div>
                                </td>
                                <td>
