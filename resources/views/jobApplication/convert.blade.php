                                ...
                                <div class="float-right col-8">
                                    ...
                                    <div class="choose-file form-group">
                                        <label for="document[{{ $document->id }}]">
                                            ...
                                            <input class="form-control  @error('document') is-invalid @enderror border-0" @if($document->is_required == 1) required @endif name="document[{{ $document->id}}]" type="file" accept=".png, .jpg, .jpeg, .pdf" id="document[{{ $document->id }}]" data-filename="{{ $document->id.'_filename'}}">
                                        </label>
