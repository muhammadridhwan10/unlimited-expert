...
class Notification extends Model
{
    ...
    public function toHtml()
    {
        ...
        if(!empty($usr))
        {
            ...
            if ($this->type == 'create_overtime') {
                $link = route('overtime.index');
                $text = $usr->name . " " . __('created overtime') . " <b class='font-weight-bold'>" . $data->name . "</b> ";
            }

            if ($this->type == 'create_medical_allowance') {
                $link = route('medical-allowance.index');
                $text = $usr->name . " " . __('created medical allowance') . " <b class='font-weight-bold'>" . $data->name . "</b> ";
            }
            

            if ($this->type == 'comment_ticketing') {
